...
function Panel({ title, options }) {
  ...
  return (
    <div className="menuContainer p-4">
      <div className="h-[44rem] flex flex-col justify-center items-center mb-16">
        ...
        <button
          ...
          className="w-[30rem] bg-yellowCol text-base text-black h-[3.5rem] px-[1.2rem] py-[0.8rem] mb-[1.2rem] rounded-md text-[1.5rem] hover:scale-110 active:scale-90 ease-in-out duration-300 cursor-pointer mt-8"
        >
          Pozovi konobara
        </button>
      </div>
